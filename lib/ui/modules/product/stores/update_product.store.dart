...
part 'update_product.store.g.dart';

class UpdateProductStore = _UpdateProductStore with _$UpdateProductStore;

abstract class _UpdateProductStore with Store, ChangeNotifier {
  @observable
